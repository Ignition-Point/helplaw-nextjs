    ...
    <>
      <section className="bg-[#1A365E] py-[40px] md:py-[60px] lg:py-[80px]">
        <div className="mx-auto max-w-7xl px-5">
          <h1 className="heading font-bold text-[32px] md:text-[42px] lg:text-[56px] leading-[1.2] align-middle capitalize text-white tracking-normal">
            Privacy <span className="text-[#FFBF0F]">Policy</span>
          </h1>
        </div>
      </section>
      <section className="py-16 sm:py-20 bg-white">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 prose-helplaw">
          <p>
            By your use of this or any Help Law Group website, you agree to the
            collection and use of information in accordance with Help Law
            Group&apos;s online privacy policy.
          </p>
          ...
          <p>
            ...
            is not limited to, your email address, name, phone number, other
            information (&quot;Personal Information&quot;).
          </p>
          <p>
            Help Law Group does not sell, trade or otherwise transfer
            users&apos; personally identifiable information to third-parties
            except when cases are referred or joint ventured with other counsel
            as agreed by clients.
          </p>
          <p>
          ...
          <h2>Remarketing</h2>
          <p>
            Help Law Group uses remarketing services to advertise on third party
          ...
          <p>
            ...
            &ndash; for your web browser. Google Analytics Opt-out Browser
          ...
          <p>
            I understand that this is an attorney advertisement and by
            contacting Help Law Group I expressly request and give permission to
            being contacted by a law firm and/or their representatives at any
            time, including but not limited to calls using an autodialer, text,
            fax or email, even if these result in charges to me by my carrier.
            Consent is not a condition for services. This consent overrides any
            do-not-call registry rules or list.
          </p>
          ...
          <p>
            ...
            Help Law Group, Inc., 3667 Voltaire Street, San Diego, California
            92106 or email us at{" "}
            <a href="mailto:support@helplaw.com">support@helplaw.com</a>.
          </p>
          <p className="text-sm text-slate-warm-400 mt-8">
            This Privacy Policy was updated as of July 15, 2022, and will
