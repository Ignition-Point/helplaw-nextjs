...
export default function AboutPage() {
  return (
    <>
      ...
      {/* ─── SECTION 1: Hero ─── */}
      <section
        className="bg-[#1A365E] py-[40px] md:py-[60px] lg:py-[80px] relative overflow-hidden z-10"
        style={{
        ...
        <div className="mx-auto max-w-7xl px-5">
          <div className="grid lg:grid-cols-2 items-center gap-8 md:gap-14 lg:gap-20">
            ...
            <div>
              ...
              <p className="mt-4 text-[16px] lg:text-[18px] leading-[140%] font-normal text-[#5C6F8B] leading-relaxed">
                Help Law Group is a law firm that also works with a broader
            ...
            <div className="grid sm:grid-cols-2 gap-6 content-start">
              {[
                ...
                <div
                  key={label}
                  className="rounded-xl border border-navy-100 bg-navy-50/50 p-6 lg:py-12 p-6 text-center"
                >
                  <p className="heading text-2xl sm:text-3xl font-bold text-[#17335D]">
                    {number}
                  </p>
                  <p className="mt-2 text-sm text-[#546885] leading-snug">
                    {label}
                  </p>
                </div>
              ))}
      ...
      <section className="py-[40px] md:py-[60px] lg:py-[80px] bg-slate-warm-50">
        <div className="mx-auto max-w-7xl px-5">
          <h2 className="heading font-bold text-[28px] md:text-[34px] lg:text-[42px] leading-[1.2] text-[#17335D] tracking-tight text-center">
          ...
          <div className="mt-6 md:mt-8 lg:mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <h3 className="heading mt-4 text-lg font-bold text-[#17335D] leading-[140%]">
                  {title}
                </h3>
                <p className="mt-2 text-sm text-[#546885] leading-relaxed">
                  {description}
                </p>
              </div>
            ))}
      ...
      <section className="py-[40px] md:py-[60px] lg:py-[80px]">
        <div className="mx-auto mx-auto max-w-7xl px-5">
          ...
          <p className="mt-4 text-[16px] lg:text-[18px] leading-[140%] text-[#546885] leading-relaxed">
      ...
      <section className="py-[40px] md:py-[60px] lg:py-[80px] bg-[#122d56]">
        <div className="mx-auto max-w-7xl px-5">
      ...
      <section className="py-[40px] md:py-[60px] lg:py-[80px] bg-white">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-3 text-[16px] lg:text-[18px] leading-[140%] font-normal text-[#5C6F8B]">
            The first conversation is free. No obligation. No pressure.
          </p>
          <Link
            href="/cases"
            className="mt-6 inline-flex items-center gap-2 rounded-full font-medium text-[14px] lg:text-[16px] leading-[100%] tracking-[0%] bg-[#122D56] px-[18px] py-[15px] text-white hover:bg-[#1A365E] transition-all"
          >
