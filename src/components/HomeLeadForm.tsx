  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={submitting}
        className="cursor-pointer block w-full max-w-[300px] mx-auto rounded-[100px] bg-[#122D56] hover:bg-[#1A365E] px-[24px] py-[16px] text-[14px] md:text-[16px] lg:text-[18px] leading-[100%] font-semibold tracking-[-0.02em] text-white"
      >
        {submitting ? (
